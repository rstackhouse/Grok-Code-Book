...
either the stable release of 0.90 or the nightly build. Unzip to C:$\backslash$Program Files\nant-\<version\> or another centrally available 
location.

Modify your \em{\%PATH\%} environment variable to point to \<NAnt-Installation-Directory\>$\backslash$bin \(i.e. C:\Program Files\nant-0.90\bin\).
